...
const ProductCards = ({ product }) => {
  return (
    <div className="bg-white p-4  shadow rounded relative border-gray-900 transform transition-transform duration-300 hover:scale-105">
      ...
      <div className="absolute bottom-4 right-2 flex items-center w-8 h-8 bg-red-600 group text-white text-sm rounded-full hover:w-32 hover:bg-red-700 transition-all">
